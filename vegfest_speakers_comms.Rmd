...
emails_schedule <- tibble(email_number = 1:13,
                          ...
                          days_from_event_text = c("6-8 months before",
                                                   ...
                                                   "Day of event",
                                                   "3 days after"),
                          email_description = c("First invitation to potential speakers",
                                                "Email to potential speakers who have declined to take part",
                                                "Email to potential speakers who have not replied to us at all",
                                                "Email to potential speakers who have accepted",
                                                "Follow-up to speakers who haven’t sent back the signed speaker agreement",
                                                "Email to speakers who have sent back the signed speaker agreement",
                                                "Follow-up email to speakers who have not sent the info requested",
                                                "Email to speakers who have supplied the requested info",
                                                "Email to speakers requesting their presentation",
                                                "Follow-up email to speakers who have not provided their presentation",
                                                "Pre-event email to speakers",
                                                NA_character_,
                                                "Post-event email to speakers"),
                          email_content = c("Introduce VegOttawa, explain we are planning a VegFest and would like to extend invitation for them to speak on X topic. Provide event dates, location, and either ask what their speaker fee would be (for more well-known speakers) or provide what we can offer as a speaker fee (for others). Indicate that we will cover travel and accommodation costs, and request an answer within a certain time frame (2 weeks?)",
                                            ...
                                            "Thank them for agreeing to participate, and include more details about what will be expected, including more details about talk length, content, themes we would advise against including, etc., plus signing the attached speaker agreement. Request the signed speaker agreement be returned to us within a certain time frame (1 week?)",
                                            ...
                                            "Drum up excitement for the event and again thank them for participating. Ask if they have any last minute questions or issues and reconfirm their travel/accommodation details. Include date, time, and place of event so they have it handy in a recent email. Outline who they should ask for when they arrive or where they should go exactly.",
                                            NA_character_,
                                            "Thank them again for their participation and making the event a success. Express that it was great to work with them and VegOttawa hopes to work with them again. Provide a link to an anonymous feedback form and also let them know they can provide non-anonymous feedback though email too."))
